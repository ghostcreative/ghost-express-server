...
class ServiceLocator {
  ...
  getAuthService () {
    if (!this._authService) {
      ...
      this._authService = AuthServiceFactory.create(this._config.get('auth'), this.getDbService().getDb());
    }
  ...
  getPermissionService () {
    if (!this._permissionService) {
      ...
      this._permissionService = PermissionServiceFactory.create({}, this.getDbService().getDb());
    }
