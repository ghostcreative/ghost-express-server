...
class AuthServiceFactory {
 ...
 static create (options, authorizationService, profileService, userService, userRoleService, roleService) {
    ...
    const loginFn = AuthServiceFactory.resolveLoginFn(options.loginFn, authorizationService, profileService, userServic);
    const registerFn = AuthServiceFactory.resolveRegisterFn(options.registerFn, authorizationService, profileService, userServic);
