...
class AuthService {
   ...
   * @param {GhostExpressServer_AuthServiceConfig} options
   */
  ...
  authenticate (req, res) {
    ...
    .catch(err => {
      if (err.message == 'Missing authorization token.' && _.has(req.routeOptions, 'auth.required') && req.routeOptions.auth.required === false) return {};
      else throw err;
    })
  }
