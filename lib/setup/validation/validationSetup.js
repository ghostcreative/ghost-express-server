...
const _GhostExpressRouteRequestValidator = require('ghost-express-route-request-validator');
const GhostExpressRouteRequestValidator = new _GhostExpressRouteRequestValidator();
